        ...
        <div id="contact"
            ...
            <div id="social" class="mx-10">
                <div class="flex flex-row space-x-3">
                    <a href="#">
                        <svg role="img" class="w-4 h-4 rotate-90" viewBox="0 0 24 24"
                    ...
                    <a href=""><svg role="img" class="w-4 h-4 rotate-90" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <title>Twitter</title>
                            <path
            ...
            <div class="flex flex-row space-x-10 transform">
                <div class="flex flex-row items-center space-x-2">
                    ...
                    <div class="font-bold">
                        <p class="leading-4">
                            1012 Nostrand ave</p>
                        <p class="leading-4">Brooklyn NY, USA</p>
                    </div>
                </div>
                <div class="flex flex-row items-center space-x-2">
                    <div>
                    ...
                    <div class="font-bold">
                        <p class="leading-4">Mon - Sat</p>
                        <p class="leading-4">8AM - 4PM</p>
                    </div>
                </div>
