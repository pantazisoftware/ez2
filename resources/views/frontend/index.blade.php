...
@section('content')
    <div class="p-2 lg:px-16">
            ...
            <div id="jumbotron-content">
                ...
                <div class="absolute top-0 bottom-0 z-10 p-12 tracking-tight lg:p-40 bg-primary/60">
                    <div id="animate" data-aos="fade-right" data-aos-delay="50" data-aos-duration="600"
                        ...
                        <h1 class="w-full text-5xl font-bold text-white uppercase md:w-5/6 lg:w-4/6 lg:text-8xl">Financial &
        ...
        <div id="jumbotron-controls"
            ...
            <div id="item1"
                class="flex flex-row hover:cursor-pointer items-center p-6 space-x-6 border-4 border-gray-200 rounded-bl-[50px] rounded-tr-[50px]">
                <div>
            ...
            <div id="item2" class="flex flex-row items-center p-6 space-x-6 hover:cursor-pointer">
                <div>
            ...
            <div id="item3" class="flex flex-row items-center p-6 space-x-6 hover:cursor-pointer">
                <div>
            ...
            <div id="item4" class="flex flex-row items-center p-6 space-x-6 hover:cursor-pointer">
                <div>
