<nav class="flex flex-row justify-between items-center py-9 bg-white px-[15px] lg:px-14">
    <div>
        <a href="">
    ...
    <div class="hidden lg:flex flex-row gap-x-5 relative">
        <a href="#"
            class="uppercase font-bold text-sm text-primary hover:text-accent trasition duration-75 ease-linear">Services</a>
        <a href="#"
    ...
    <div class="absolute top-24 left-0 right-0 mx-16 bg-white drop-shadow-3xl">
            ...
            <div id="menu" class="w-2/3 flex justify-center divide-x py-10 divide-gray-200">
                <div class="flex flex-col pb-10 px-10 w-full">
                    ...
                    <div class="flex flex-col space-y-4">
                        <a href="#" class="text-primary hover:text-accent">Case 1</a>
                        <a href="#" class="text-primary hover:text-accent">Case 2</a>
                        <a href="#" class="text-primary hover:text-accent">Case 3</a>
                        <a href="#" class="text-primary hover:text-accent">Case 4</a>
                    </div>
                </div>
                <div class="flex flex-col pb-10 px-10 w-full">
                    <h2 class="font-bold text-primary pb-8">Services</h2>
                    <div class="flex flex-col space-y-4">
                        <a href="#" class="text-primary hover:text-accent">Service 1</a>
                        <a href="#" class="text-primary hover:text-accent">Service 2</a>
                        <a href="#" class="text-primary hover:text-accent">Service 3</a>
                        <a href="#" class="text-primary hover:text-accent">Service 4</a>
                    </div>
                </div>
                <div class="flex flex-col pb-10 px-10 w-full">
                    <h2 class="font-bold text-primary pb-8">Teams</h2>
                    <div class="flex flex-col space-y-4">
                        <a href="#" class="text-primary hover:text-accent">Team 1</a>
                        <a href="#" class="text-primary hover:text-accent">Team 2</a>
                        <a href="#" class="text-primary hover:text-accent">Team 3</a>
                        <a href="#" class="text-primary hover:text-accent">Team 4</a>
                    </div>
                </div>
            </div>
